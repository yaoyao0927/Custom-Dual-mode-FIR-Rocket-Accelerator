...
VL_INLINE_OPT void VTestHarness::_sequent__TOP__2525(VTestHarness__Syms* __restrict vlSymsp) {
    ...
    if (vlTOPp->TestHarness__DOT__chiptop__DOT__system__DOT__resetSynchronizer__DOT__bundleOut_0_member_allClocks_subsystem_sbus_0_reset_catcher_io_sync_reset) {
        ...
        if (vlTOPp->TestHarness__DOT__chiptop__DOT__system__DOT__tile_prci_domain__DOT__tile_reset_domain__DOT__tile__DOT__firAccel__DOT___T) {
            ...
            if ((6U == (IData)(vlTOPp->TestHarness__DOT__chiptop__DOT__system__DOT__tile_prci_domain__DOT__tile_reset_domain__DOT__tile__DOT__firAccel__DOT__FIR__DOT__state_reg))) {
                                                      ...
                                                      (1U 
                                                       & (IData)(
                                                                 (vlTOPp->TestHarness__DOT__chiptop__DOT__system__DOT__tile_prci_domain__DOT__tile_reset_domain__DOT__tile__DOT__firAccel__DOT__FIR__DOT__sum 
                                                                  >> 0x27U)))))))) 
                        << 0x28U) | vlTOPp->TestHarness__DOT__chiptop__DOT__system__DOT__tile_prci_domain__DOT__tile_reset_domain__DOT__tile__DOT__firAccel__DOT__FIR__DOT__sum);
            }
        }
    }
